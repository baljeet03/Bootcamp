Project::Application.routes.draw do
  ...
  match '/notifications/show' => 'notifications#show', :as => :reminders
  match '/notifications/delete/:id' => 'notifications#delete', :as => :reminder_delete
  match '/notifications/deleteAll' => 'notifications#deleteAll', :as => :reminder_clear
